...
class ApartmentsExplorePage extends StatefulWidget {
  @override
  _ApartmentsExplorePageState createState() => _ApartmentsExplorePageState();
}

class _ApartmentsExplorePageState extends State<ApartmentsExplorePage> {
          ...
          builder: (context, snapshot) {
            if(listCount == 0){
              return _isLoading ? loader2 : Center( child: Container(
                child: Text("There are no facilities to show", style: const TextStyle(fontSize: 16.0),),
              ));
            }else{
