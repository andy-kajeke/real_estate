...
class VillasExplorePage extends StatefulWidget {
  @override
  _VillasExplorePageState createState() => _VillasExplorePageState();
}

class _VillasExplorePageState extends State<VillasExplorePage> {
