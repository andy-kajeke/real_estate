...
class BungalowsExplorePage extends StatefulWidget {
  @override
  _BungalowsExplorePageState createState() => _BungalowsExplorePageState();
}

class _BungalowsExplorePageState extends State<BungalowsExplorePage> {
