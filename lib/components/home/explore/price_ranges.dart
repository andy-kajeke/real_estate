...
class PriceRangesExplorePage extends StatefulWidget {
  final int minPrice;
  final int maxPrice;

  PriceRangesExplorePage({required this.minPrice, required this.maxPrice});
  @override
  _PriceRangesExplorePageState createState() => _PriceRangesExplorePageState();
}

class _PriceRangesExplorePageState extends State<PriceRangesExplorePage> {
  ...
  Future<List<PropertyModel>> getAllFacilities() async {
    Map data = {
      "property_cost_min": widget.minPrice.toString(),
      "property_cost_max": widget.maxPrice.toString(),
    };
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        for(i = 0; i < facilityGallery.length; i++){
          photos = facilityGallery[i] as List;
        }
        return InkWell(
          onTap: (){
