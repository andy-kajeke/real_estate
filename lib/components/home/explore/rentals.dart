...
class RentalsExplorePage extends StatefulWidget {
  @override
  _RentalsExplorePageState createState() => _RentalsExplorePageState();
}

class _RentalsExplorePageState extends State<RentalsExplorePage> {
